...
def login():
   ...
   if form.validate_on_submit():
      ...
      if user and bcrypt.check_password_hash(user.password,form.password.data):
         ...
         flash('User not found.Check email and password','danger')
...
def account():
   ...
   if form.validate_on_submit():
      ...
      form.email.data=current_user.email
         ...
         flash('Image is not in correct format','danger')
...
@app.route('/announce')
def announce():
    return render_template("announce.html",title='announcement')